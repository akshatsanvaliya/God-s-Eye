...
//                                        nome do arquivo: idpessoa + a contagem de fotos. ex: person.10(id).6(sexta foto).jpg
                                            String cropped = "C:\\Users\\Admin\\Pictures\\." + txt_id_label.getText() + "." + sample + ".jpeg";
                                        ...
                                        if (sample > 25) {
                                            ...
                                            System.out.printf("File Generated",String.valueOf(sample));
