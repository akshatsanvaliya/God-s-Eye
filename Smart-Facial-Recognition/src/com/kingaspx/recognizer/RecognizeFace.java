...
public class RecognizeFace extends javax.swing.JDialog {
    ...
    CascadeClassifier cascade = new CascadeClassifier("D:\\Programs\\Java\\Facial-Recognition\\haarcascade_frontalface_default.xml");
    ...
    public RecognizeFace(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        recognizer.read("D:\\Smart-Facial-Recognition\\classifierLBPH.yml");
                        ...
                        if (webSource.grab()) {
                            ...
                            for (int i = 0; i < detectedFace.size(); i++) {
                                ...
                                if (prediction == -1) {
                                    ...
                                    idPerson = 0;
                                    label_name.setText("Not in Database");
                                    ...
                                    idPerson = prediction;
                                    System.out.println("Person is: " + idPerson);
                                    System.out.println("name is: - " + firstNamePerson);
