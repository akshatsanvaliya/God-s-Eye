...
public class SendWhatsapp extends javax.swing.JDialog {
    ...
    public SendWhatsapp(java.awt.Frame parent, boolean modal, String nome, String telefone) {
        ...
        text_lbl.setText("Hey, " + name + "You've been tracked!!!");
        System.out.println("\"Hey, \" + name + \"You've been tracked!!!\"");
    }
    ...
    private void initComponents() {
        ...
        caracteres_label.setText("0 Character");
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
        ...
        try {
            dispose();
            String url = "https://api.whatsapp.com/send?phone=+91" + tel.replace(" ", "").replace("", "").replace("", "").replace("", "") + "&text=" + text_lbl.getText().replace(" ", "%20"); //India code
    ...
    private void text_lblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_text_lblKeyReleased
        if (text_lbl.getText().length() == 1) {
            caracteres_label.setText(text_lbl.getText().length() + " Characters");
        } else {
            caracteres_label.setText(text_lbl.getText().length() + " Characters");
        }
